...
Here are the source code files for the Jupyter notebooks and Python scripts used in this lesson. You can also find everything in the [`./model/python`](../model/python/) directory.
...
We will discuss the sequence of steps in the Notebook further during the workshop.
